...
namespace Sobee.TestServer.Messages.Ball
{
    ...
    public class BallShootMessage : Message
    {
        public BallShootMessage(BinaryReader gclass315_0) : base(gclass315_0)
        {
        ...
        public BallShootMessage(float strength, Vector2 direction)
        {
