...
namespace Sobee.TestServer.Messages.Ball
{
    ...
    public class BallPositioningHit : Message
    {
        public BallPositioningHit(BinaryReader gclass315_0) : base(gclass315_0)
        {
        ...
        public BallPositioningHit(float strength, Vector2 direction, HitSubType hitSubType)
        {
            Strength = strength;
            Direction = direction;
