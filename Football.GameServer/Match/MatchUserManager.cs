...
{
    public class MatchUserManager<TRoom, TPlayer> : SessionManager<TRoom, TPlayer>
        where TRoom : MatchRoom
        where TPlayer : MatchUser
    {
        ...
        public virtual bool TryCreate(LobbyUser authUser)
        {
            if (Owner == null)
            {
