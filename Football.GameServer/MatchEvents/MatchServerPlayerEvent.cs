...
namespace Football.GameServer.MatchEvents
{
    public class MatchServerPlayerEvent
    {
        ...
        public static void PlayerJoinReceived(MatchRoom matchRoom, MatchUser matchPlayer)
        {
        ...
        public static void PlayerLeaveReceived(MatchRoom matchRoom, MatchUser matchPlayer, PlayerMatchInformationMessage matchPlayerInformation)
        {
            if (matchRoom == null || matchPlayer == null || matchPlayer.AuthInformation == null)
            {
