...
namespace Football.GameServer.Messages.Auth
{
    [Message(29475)]
    public sealed class MatchClientAuthInfoRxMessage : Message
    {
        ...
        public MatchClientAuthInfoRxMessage(BinaryReader reader) : base(reader)
        {
        ...
        public MatchClientAuthInfoRxMessage(
            Version version,
            long unknown,
            string password,
