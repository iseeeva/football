...
namespace Football.GameServer.Messages.Match
{
    ...
    public class MatchInformationMessage : Message
    {
        ...
        public MatchInformationMessage(
            IEnumerable<PlayerMatchInformationMessage> homePlayers,
            IEnumerable<PlayerMatchInformationMessage> awayPlayers,
            IEnumerable<PlayerMatchInformationMessage> homeSpectators,
            IEnumerable<PlayerMatchInformationMessage> awaySpectators,
            Guid clientId,
            sbyte clientCamera,
            sbyte ballOwner,
            ...
            IEnumerable<string> ienumerable_5, SittingIdInfo sittingIdInfo,
            ...
            )
        {
            ...
            BallOwner = ballOwner;
            HomePlayer = new List<PlayerMatchInformationMessage>(homePlayers);
            AwayPlayer = new List<PlayerMatchInformationMessage>(awayPlayers);
            HomeSpectator = new List<PlayerMatchInformationMessage>(homeSpectators);
            AwaySpectator = new List<PlayerMatchInformationMessage>(awaySpectators);
